    ...
    <div className='content'>
      ...
      <div className='cardish'>
        <p> 
            ...
            <p> Clockwise is my favorite method, it binds the keypins and driver pins first. You attempt to set the rotation of the pins by lifting and push/pull the key pin. Once you are confident in its rotation, push to sheer. Once you have done this with all the keypins and the driver pins are set to sheer, you should fall into a false set. This means one or more pins are in a false gate. Simply lighen tension a little bit and attempt to move the key pins into their true gate and the lock will open once they are fixed! Many say Clock wise is a harder method.
            </p>
            <p> 
              Counter clockwise is the most popular way to open medecos, this binds the sidebar first. This involves setting the rotations to the sidebar first. Once you can add firm tension and all the pins lift without resistance, you are set to sidebar. Add normal tension again and push the pins to sheer. 
            </p>
